                ...
                <h4 class="header-title">Project List</h4>
                    <div class="data-tables datatable-dark">
                            <table id="dataTable3" class="text-center">
                                ...
                                <tbody>
                                    <?php
                                        $stmt = $ProjectList->runQuery("SELECT * FROM apollo_projectlist ORDER BY project_code DESC");
                                        $stmt->execute();
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#editmodal<?php echo $row['project_code'];?>" class="btn btn-success btn-xs mb-3" data-toggle="modal" >Edit</a></td>
                                    </tr>
                                <?php
                                ?>
                                    <!-- Modal -->
                                        <div class="modal fade" id="editmodal<?php echo $row['project_code'];?>">
                                                    ...
                                                    <div class="modal-body">
                                                        <?php
                                                            $ProjectCode = $row['project_code'];
                                                                $stmtss = $ProjectList->runQuery("SELECT * FROM apollo_projectlist WHERE project_code = $ProjectCode");
                                                                $stmtss->execute();
                                                                $rows = $stmtss->fetch();
                                                        ...
                                                        <form method ="post" action="posting.php">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="ProjectCode" class="ProjectCode form-control" id="ProjectCode" value="<?php echo $A?>" readonly>
