        ...
        $row = $stmts->fetch();			
            ...
            if ($row ==0) {
                 ...
                 if($result = $AssignedWorks->AssiningWorksToProject($CapexNo,$ContractAmount,$ScopeIDParent,$Scope,$ScopeAmount, $userAccount)){
                    if($result2 = $AssignedWorks->AssiningSubScopeToProject($ParentId, $CapexNo, $GenScopes, $ArrayScopeId, $SubScopes, $Percent, $WorkStat, $PlannedStart, $PlannedEnd, $ActualStart, $ActualEnd, $Remarks, $Approval_status, $NumDays)){
