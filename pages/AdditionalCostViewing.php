...
$Ac = $_GET['ac'];
    if(isset($_SESSION['position'])){
        ...
        $Pending->execute();
            ...
            $billingList = $GlobalConnection->runQuery("SELECT * FROM `apollo_additional_cost` Where capex_number ='$Capex' AND contract_price = '$Ac'");
            $billingList->execute();
                                ...
                                <div class="data-tables">
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        <thead class="bg-light text-capitalize">
                                                <tr>
                                                    <th class="table-primary" style="background-color:#7855ed; color:white;" width="10%">Date</th>
                                                    <th class="table-primary" style="background-color:#7855ed; color:white;" width="50%">Billing</th>
                                                    <th class="table-primary" style="background-color:#7855ed; color:white;" width="10%">Status</th>
                                                    <th class="table-primary" style="background-color:#7855ed; color:white;"width="10%">Billable</th>
                                                ...
                                                while($rowprojectlist  = $billingList->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-1 mb-3">
                                                            ...
                                                            <input type="text" name="" class="form-control" value="<?php echo $rowprojectlist['capex_number']?>" readonly>
                                                        
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <label for="validationCustom01">Project Name</label>
                                                            <input type="text" name="" class="form-control" value="<?php echo $rowprojectlist['project_name']?>" readonly>
                                                        
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <label for="validationCustom01">Contractor Name</label>
                                                            <input type="text" name="" class="form-control" value="<?php echo $rowprojectlist['contractor']?>" readonly>
