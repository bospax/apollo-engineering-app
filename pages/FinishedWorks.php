                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Finished Works</h4>
                    ...
                    <div class="col-12 mt-5" id="AssignedProjectList">
                        <div class="card">
                            <div class="card-body">                              
                                ...
                                <h4 class="header-title">Finished Works</h4><hr> 
                                <div>
...
$(document).ready(function(){  
    ...
    $( "#FilterCapex" ).change(function() {
        ...
        $.ajax({
            type: "POST",
            url: "ProjectMonitoring/SearchFinishedWorks.php",
...
function SearchCapexNum(val){
    ...
    function ChangeStatus(val){
        ...
        $.ajax({
            type: "POST",
            url: "ProjectMonitoring/ClosingOfWorks.php",
            data: {Id:Id},
            success: function(resulta){
                $("#ClosingWorksAlert").html(resulta);
                // alert(resulta);
                // console.log(response);
                // location.reload("#dataTable");
                setTimeout(function(){
                    $( "#data-tables" ).load( "FinishedWorks.php #data-tables" );
                    reloadData();
                    }, 250);             
            }
          });
