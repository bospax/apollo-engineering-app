<?php
    ...
    // this is for billing history
        ...
        apollo_laborandmaterialcost_list.capex_number, apollo_laborandmaterialcost_list.contract_amount,apollo_laborandmaterialcost_list.scope_amount");
        $stmts->execute();
...
// AND billing_date = '$PreparedDate' 
    $stmts = $Computations->runQuery("SELECT * From apollo_progressbillinglist WHERE capex_number='$CapexNumber' AND progress = '$ProjectProgress'");
    $stmts->execute();
    $row = $stmts->fetch();
    if($row==0){
