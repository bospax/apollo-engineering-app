                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Project Cost Details</h4>
                                                ...
                                                while($row = $view->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            ?>  
                                                            <td>
                                                            <a href="ViewingOfBillingTagging.php?id=<?php echo $row['capex_number']?>" class="btn btn-secondary btn-xs mb-2 fa fa" value=""> View Details</a>
                                                            </td>                                                          
                                                        </tr> 
                                                    <?php                               
                                                }
