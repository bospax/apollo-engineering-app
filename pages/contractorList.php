...
<head>
    ...
    <script src="InputContractorList/script.js"></script>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Contractor List</h4>
            ...
            <div class="main-content-inner">
                <div class="row" >
                     <div class="col-lg-4 col-ml-12" id="AddNewContractorListForm">
                     
                    </div>
                     <div class="col-lg-8 " id="TableContent">
