    ...
    ?>
        ...
        <!-- to get information with other table -->
            ...
            <?php
                    ...
                    WHERE apollo_laborandmaterialcost_list.capex_number = '$FilterCapex' 
                    GROUP BY  apollo_laborandmaterialcost_list.capex_number, apollo_laborandmaterialcost_list.contract_amount, apollo_laborandmaterialcost_list.scope, apollo_laborandmaterialcost_list.scope_amount");
                    $stmt->execute();
