    <?php
        ...
        $notif = $GlobalConnection->runQuery("SELECT COUNT(subscopes)AS Notif FROM `apollo_project_assigned_scopes`
                            ...
                            <?php
                                ...
                                $nav = $Navigations->fetch();
                                 ...
                                 <?php    
                                    ...
                                    <li ><a href="SecondApproverHistory.php" ><i class="ti-list"></i> <span>History</span></a></li>
                                    <li ><a href="ContractAmountApproval.php"><i class="fa fa-list"></i> <span>CA Approval<span class="badge badge-danger"><?php echo $CaCountApproval?></span></span></a></li>
                                    <?php    
                                    ...
                                    ?>
                                        ...
                                        <li><a href="ProjectSummary.php"><i class="fa fa-file"></i> <span>Project Overview</a></li>
                                        <li ><a href="ApprovalHistory.php" ><i class="ti-list"></i> <span>Billing Approval</span></a></li>
                                    <?php
                                }                   
                            ?>
                        </ul>
