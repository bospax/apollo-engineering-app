                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">Closing OF Works</h4>
                    ...
                    <div class="col-12 mt-5" id="AssignedProjectList">
                        <div class="card">
                            <div class="card-body">                              
                                ...
                                <h4 class="header-title">Closing Of Works Confirmation</h4>
                                <hr>                                                                                
                                <div class="data-tables">                                                                          
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                        <?php
                                            $view = $GlobalConnection->runQuery("SELECT * FROM  apollo_project_assigned_scopes WHERE work_status = 'Pending To Close'");
                                            $view->execute();
                                                while($row = $view->fetch(PDO::FETCH_ASSOC))
                                                {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><button class="btn btn-secondary btn-xs mb-3 btnConfirm" type="type" id="   <?php echo $row['id']?>"  onclick="ChangeStatus(this.value)" value="<?php echo $row['id']; ?>">Confirm</button></td>  
                                                        </tr> 
                                                    <?php                               
                                                }
                                            ?>
...
$(document).on("click", ".btnConfirm", function(){
     ...
     $.ajax({
            type: "POST",
            url: "Confirmations/ClosingOfWorks.php",
            data: {Id:Id},
