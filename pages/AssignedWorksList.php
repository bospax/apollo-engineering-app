                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" id="ContainerTitle">View Work List</h4>
                    ...
                    <div class="col-12 mt-5" id="AssignedProjectList">
                        <div class="card">
                            <div class="card-body">                              
                                ...
                                <h4 class="header-title">List of Works</h4>
                                <HR>
                                <div>
                                    ...
                                    <input type="text" class="form-control col-md-3 mb-3" id="Pname" value="" placeholder="Project Name" readonly>
