...
if(isset($_SESSION['position'])){
    ...
    if($Position == 'Eo'){
        $stmt = $GlobalConnection->runQuery("SELECT * FROM apollo_enrolledproject WHERE project_status = 'Open' AND engineer='$fullname'");
        $stmt->execute();
    }
    else{
...
<head>
    ...
    <!--<script src="ProjectMonitoring.js"></script>-->
