                                ...
                                <div class="data-tables">                                                                          
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <?php
                                            ...
                                            WHERE apollo_enrolledproject.project_status in('Open','Completed')
                                                                ...
                                                                if($row['project_status']=='Open'){
                                                                    ...
                                                                    if($Position == 'Admin'){
                                                                        ...
                                                                        ?>
                                                                            <td>
                                                                            <!--<td><button class="btn btn-secondary btn-xs mb-2 btnConfirm" type="type" id="<?php echo $row['project_num']?>"  onclick="ChangeStatus(this.value)" value="<?php echo $row['project_num']; ?>">To Close</button>-->
                                                                            <a href="ClosingOfProjectViewing.php?id=<?php echo $row['capex_number']?>" class="btn btn-secondary btn-xs mb-2 fa fa" value=""> View</a></td>  
                                                                        <?php
                                                                    }
