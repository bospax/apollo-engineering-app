                                        ...
                                        <div align="right">
                                            ...
                                            <table class="table table-striped" border="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                        $stmts = $GlobalConnection->runQuery("SELECT * From apollo_additional_cost WHERE capex_number='$Capex' and id = '$IdOfBilling' and billing_type='Initial Payment (Additional Works)'");
                                                        $stmts->execute();
                                                        $row_c = $stmts->fetch();
                                                        ...
                                                        $resContract =  $G->format($contractor_amount);
                                                                ...
                                                                $stmtsss = $GlobalConnection->runQuery("SELECT * From apollo_enrolledproject WHERE capex_number='$Capex'");
                                                                $stmtsss->execute();
                                                                $row = $stmtsss->fetch();
                                                                $contractAmt = $row['ecost'];
                                                    ...
                                                    ?>
                                                        ...
                                                        ₱<?php echo $contractAmt ?>-₱<?php echo $contractAmt ?>+₱<?php echo $contractor_amount?> = <b>₱<?php echo $contractor_amount?></b><br>
                                                        Thank You!<br><br>
                                        ...
                                        <div align="right">
                                            ...
                                            <table class="table table-striped" border="2">
                                                ...
                                                <tr>
                                                    <td class="txtInside" colspan="12">
                                                    <?php 
                                                        $stmts = $GlobalConnection->runQuery("SELECT * From apollo_additional_cost WHERE capex_number='$Capex' and id = '$IdOfBilling' and billing_type='Full Payment (Additional Works)'");
                                                        $stmts->execute();
                                                        $row_c = $stmts->fetch();
                                                        $contractor_amount = $row_c['contract_price'];
                                                        $G = new NumberFormatter("en", NumberFormatter::SPELLOUT);
                                                    ...
                                                    ?>
                                                        <p>Sir / Ma'am,<br>
                                                        This is to request an additional budget allocation for the awarded contract amount & additional works at <br>
                                                        <?php echo $pname?> Project which was done by <b><?php echo $contractor?></b> amounting to <b><?php echo $contractor_amount?></b>-<?php echo ucwords($resContract);?> Thousand Pesos <br>
                                                        under CIP# <?php echo $Capex?>. Below are the breakdowns of cost. <br><br>
