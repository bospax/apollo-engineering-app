...
<body>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
           ...
           <br>
                <div align="center">
                <a href="ProjectCostDetailsAudit.php" class="btn btn-info mb-3" ><<<< Back</a>
                </div>
                                    ...
                                    <div class="table-responsive" id="TableCostDetails">
                                        <table class="table table-bordered table-striped" >
                                            <thead>
                                                ...
                                                <th class="table-primary" style="background-color:#7855ed; color:white;" width="5%">Capex Number</th>
