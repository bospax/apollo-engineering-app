...
<!--    <script src="https://cdn.fusioncharts.com/fusioncharts/latest/fusioncharts.js"></script>-->
    <script src="../assets/fusioncharts-suite/js/fusioncharts.js"></script>
<!--    <script src="https://cdn.fusioncharts.com/fusioncharts/latest/themes/fusioncharts.theme.fusion.js"></script>-->
    <script src="../assets/fusioncharts-suite/js/themes/fusioncharts.theme.fusion.js"></script>
                ...
                <div class="col-12 mt-3" id="AssignedProjectList">
                        <div class="card">
                            <div class="card-body">                              
                                ...
                                <LEFT><h4 class="header-title">Project Gantt Chart</h4></LEFT>
                                <div class="form-row">
