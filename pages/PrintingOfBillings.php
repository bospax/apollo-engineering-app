                                    ...
                                    <div class="table-responsive" id="TableCostDetails">
                                        <table id="dataTable" class="table table-bordered table-striped" >
                                            ...
                                            <?php
                                                    ...
                                                    $stmts = $GlobalConnection->runQuery("SELECT * FROM apollo_masterlistofbillings WHERE billing_status IN (1,3) ORDER BY billing_status ASC");
                                                    $stmts->execute();
                                                    ...
                                                    <tr>                                       
                                                        ...
                                                        <td><b>₱<?php echo number_format(($CaRemoveComma), 2);?></b></td>
                                                        <td><b><?php echo $rows['billing_type'];?></b></td>
                                                        <td><b><?php echo number_format ($rows['progress'], 2)?>%</b></td>
                                                        <td><b><h5><span class="badge badge-info">₱<?php echo number_format(($baRemoveComma),2) ?></span></h5></b></td>
                                                        <td>
                                                            <?php
                                                                if($rows['billing_status']==3){
                                                                    ?>
                                                                        <h6><b><span class="badge badge-success"><?php echo 'Printed';?></span></b></h6>
                                                                    <?php
                                                                } 
                                                                else{
                                                                    ?>
                                                                        <h6><b><span class="badge badge"><?php echo 'To Print';?></span></b></h6>
                                                                    <?php
                                                                }   
                                                            ?>
                                                        </td>
