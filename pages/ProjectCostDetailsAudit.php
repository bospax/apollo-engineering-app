                                ...
                                <div class="data-tables">                                                                          
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <?php
                                            ...
                                            $view = $GlobalConnection->runQuery("SELECT apollo_enrolledproject.project_num,apollo_enrolledproject.capex_number,
                                            apollo_enrolledproject.project_name,apollo_enrolledproject.contractor,apollo_enrolledproject.engineer,
                                            apollo_enrolledproject.project_status, apollo_projectlist.budgeted_amount, apollo_enrolledproject.ecost AS CA,
                                            apollo_additional_cost.contract_price AS AC, MAX(apollo_masterlistofbillings.progress) as Progress 
                                            ...
                                            ON apollo_enrolledproject.capex_number = apollo_projectlist.capex_number 
                                            
                                            GROUP BY apollo_enrolledproject.capex_number,apollo_enrolledproject.project_num,apollo_projectlist.budgeted_amount,apollo_additional_cost.contract_price
                                                        ...
                                                        <tr>
                                                            ...
                                                            if($row['AC']==''){
                                                                ...
                                                                ?>
                                                                    <!--<td><b>₱<?php echo $row['AC']; ?></b></td>-->
                                                                     <td>₱<?php echo $row['AC']; ?><a href="AdditionalCostViewing.php?id=<?php echo $row['capex_number']?>&ac=<?php echo $row['AC']?>" class="" value=""> Details</a></td>
                                                                <?php 
                                                            }
                                                            ?>  
                                                            ...
                                                            <?php
                                                                if($row['project_status']=='Open'){
                                                                    ?>
                                                                        <td> <span class="badge badge-info"><?php echo $row['project_status'];?></span></td>
                                                                         
                                                                    <?php
                                                                }elseif($row['project_status']=='Closed'){
                                                                    ?>
                                                                        <td> <span class="badge badge-warning"><?php echo 'Waiting' ;?></span></td>
                                                            ...
                                                            ?>  
                                                            <td>
                                                             <a href="ViewingOfBillingAudit.php?id=<?php echo $row['capex_number']?>" class="btn btn-secondary btn-xs mb-2 fa fa" value=""> View Details</a>
                                                            </td>                                                          
                                                        </tr> 
                                                    <?php                               
                                                }
