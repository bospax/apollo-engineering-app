                            ...
                            <div class="card-body">
                                <div class="form-row">                                 
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <option value=""></option>
                                            <?php
                                                    $view = $GlobalConnection->runQuery("SELECT * FROM apollo_enrolledproject WHERE project_status like '%Closed%'");
                                                    $view->execute();
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                while ($rowSub = $subscope->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input style="background-color:#e9e3f3" class="ActualStart form-control" name="ActualStart[]" id="ActualStart" value="<?php echo date('Y-m-d');?>" type="date"></td>
