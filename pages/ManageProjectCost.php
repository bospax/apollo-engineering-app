                                                    ...
                                                    <tr>                                       
                                                        ...
                                                        <?php
                                                            ...
                                                            { 
                                                                ?>
                                                                    <td>
                                                                        <button type="button" id="RequestToPrint" onclick="Printing(this.value,'<?php echo $TriggerCapex ?>')" class="btn btn-outline-secondary mb-3 fa fa-print" value="<?php echo $rows['billingNumber']?>"></button>
                                                                    </td>
                                                                <?php 
                                                            }
